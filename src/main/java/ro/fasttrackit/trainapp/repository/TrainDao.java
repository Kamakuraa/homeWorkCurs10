...
public class TrainDao {
    ...
    public List<Train> getAll(TrainsFilter filters) {
    ...
    private Criteria getLocationCriteria(TrainsFilter filters) {
    ...
    private Criteria getTrainCriteria(TrainsFilter filters) {
